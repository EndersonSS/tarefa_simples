...
class _CreateNewTaskState extends State<CreateNewTask> {
  ...
  TimeOfDay? _startTime, _endTime = TimeOfDay.now();
  late String _taskName;
  final _formKey = GlobalKey<FormState>();
  bool isLoading = false;
  late Group _value = Group(
    id: '1',
    title: '',
    icon: Icons.abc,
    color: Colors.black,
  ...
  void saveForm() async {
    ...
    if (_startTime == null || _endTime == null) {
      func.showError(
          "Um ou mais campos estão vazios. Por favor, preencha todos os campos.",
          context);
      return;
    }
    setState(() {
    ...
    try {
      final _id = FirebaseFirestore.instance
          .collection('Users')
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: DropdownButton<Group>(
                                    ...
                                    value:
                                        _value.title.isNotEmpty ? _value : null,
                                  ),
                                ),
                              ],
                            ),
