...
class CategoryButton extends StatelessWidget {
  ...
  const CategoryButton(
      this.context, this.grp, this.function, this.isVisible, this.reload);
    ...
    showDialog(
        ...
        builder: (ctx) {
          return AlertDialog(
            ...
            content: Text(
              "Todas as tarefas nesta categoria também serão excluídas.",
            ),
            actions: [
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: () async {
                      try {
                        final _task = FirebaseFirestore.instance
                            .collection('Users')
                            .doc(FirebaseAuth.instance.currentUser!.uid)
                            .collection('Tasks');
                        await _task.get().then((value) {
                          value.docs.forEach((element) {
                            if (Task.fromMap(element.data()).category.id ==
                                grp.id) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Categoria deleteda com sucesso")));
                      } catch (error) {
                        Navigator.of(context).pop();
    ...
    return Center(
      ...
      children: [
        ...
        Visibility(
          ...
          visible: isVisible && grp.title != "Pessoal",
        )
      ],
    ));
  }
